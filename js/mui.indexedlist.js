...
(function($, window, document) {
	...
	var IndexedList = $.IndexedList = $.Class.extend({
		...
		caleLayout: function() {
			var self = this;
			var withoutSearchHeight = (document.getElementById('app').offsetHeight - self.el.search.offsetHeight) + 'px';
			self.el.bar.style.height = withoutSearchHeight;
			self.el.inner.style.height = withoutSearchHeight;
			var barItemHeight = ((document.getElementById('app').offsetHeight - 64) / self.el.barItems.length) + 'px';
